...
:desc-listing-SnipConfigjava: Ausschnitt BeispielApplication.java
[id="listing-SnipConfigjava",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-SnipConfigjava}
[source,java]
----
@Configuration
...
:desc-listing-Snipwebxml2: Ausschnitt WebConfig.java
...
Das heißt die Flows sind in Unterordnern von `/WEB-INF/gui` abzulegen und als Namenkonvention mit `Flow.xml` enden (z.B. `beispielFlow.xml`).
...
:desc-listing-maskentextebean: Maskentexte
[id="listing-maskentextebean",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-maskentextebean}
[source, java]
----
    /**
...
Die Konfiguration der Sicherheitskomponente ist im Konzept <<NutzungsvorgabenSicherheit>> beschrieben.
...
:desc-listing-sec: Konfiguration Sicherheitskomponente
[id="listing-sec",reftext="{listing-caption} {counter:listings }"]
.{desc-listing-sec}
[source,java]
----
    @Bean
...
:desc-listing-beispielEinbindungServlet: Beispielhafte HandlerServlet-Konfiguration
