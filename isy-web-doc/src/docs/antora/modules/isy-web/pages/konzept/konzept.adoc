...
:linkaktuell: xref:isyfact-standards-doku:isy-service-rest:konzept/master.adoc[Konzept REST]
...
|====
:linkaktuell: Konzept isy-web-angular (Anmerkung: Dies ist noch ein Closed Source Baustein)
include::glossary:miscellaneous:partial$deprecated-baustein.adoc[]
