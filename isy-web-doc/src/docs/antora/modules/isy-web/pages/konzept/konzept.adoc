...
*Einfachheit des Session-Managements:* Hier wird definiert, wie die Behandlung von Session Informationen erfolgen soll und welche Möglichkeiten dazu Verfügung gestellt werden.
