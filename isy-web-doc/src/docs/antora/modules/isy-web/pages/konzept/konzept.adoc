...
Ein Beispiel dafür ist die GUI einer xref:glossary::terms-definitions.adoc#glossar-geschaeftsanwendung[Geschäftsanwendung] zur Datenerfassung, wobei die Speicherung der Daten über einen Service einer anderen Fachanwendung implementiert ist.
