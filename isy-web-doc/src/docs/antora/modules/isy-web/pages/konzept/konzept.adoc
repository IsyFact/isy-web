...
Durch diese ist es möglich, bereits einen zum xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept] konformen Rahmen zur Verfügung zu stellen, in welchen die
...
Für die Arbeit mit JSF werden gemäß dem xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept] sowohl Seitenelemente als auch Bedienelemente bereitgestellt.
