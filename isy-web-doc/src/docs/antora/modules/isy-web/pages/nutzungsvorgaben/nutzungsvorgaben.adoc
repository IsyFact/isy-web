...
Allgemeine Angaben zur Gestaltung von Oberflächen finden sich im xref:isyfact-standards-doku:isy-style:styleguide.adoc[Styleguide].
// end::inhalt[]
...
Für die Erstellung von Web-GUIs existieren Vorgaben in Form eines xref:isyfact-standards-doku:isy-style:styleguide.adoc[Styleguides].
...
image::nutzungsvorgaben/DispNameVersTitle.png[align="center",width=60%,pdfwidth=60%]
...
Die Darstellung von Fehlern und Validierungsnachrichten wird auch im xref:isyfact-standards-doku:isy-style:styleguide.adoc[Styleguide] beschrieben.
...
Die Validierung in der xref:glossary:glossary:master.adoc#glossar-Anwendungskontext#glossar-gui[GUI], aber spätestens im xref:glossary:glossary:master.adoc#glossar-anwendungskern[Anwendungskern], muss die fehlerhafte Eingabe feststellen.
...
Hierzu finden sich weitere Informationen im Dokument xref:isyfact-standards-doku:isy-exception-core/master.adoc[Konzept Fehlerbehandlung].
...
Im xref:isyfact-standards-doku:isy-style:styleguide.adoc[Styleguide] finden sich Beispiele für Druckansichten.

.Seitendruck über Druck-Funktion des Browsers
[id="image-seitendruck1",reftext="{figure-caption} {counter:figures}"]
image::nutzungsvorgaben/Browser_Druckfunktion.png[align="center", scaledwidth="96%"]
...
image::nutzungsvorgaben/header-aufbau.png[align="center", width=80%, pdfwidth=80%]
...
.Kein Javascript
[id="nojs",reftext="{figure-caption} {counter:figures}"]
...
Die Anwendung zeigt die Features der xref:glossary:glossary:master.adoc#glossar-bibliothek[Bibliotheken] `isy-web` sowie `isy-style` beispielhaft.
...
image::nutzungsvorgaben/horizontale-navigation-submenu.png[align="center", width="60%", pdfwidth="60%"]
