...
Allgemeine Angaben zur Gestaltung von Oberflächen finden sich im xref:isyfact-standards-doku:isy-styleguide:styleguide.adoc[Styleguide].
...
Für die Erstellung von Web-GUIs existieren Vorgaben in Form eines xref:isyfact-standards-doku:isy-styleguide:styleguide.adoc[Styleguides].
...
Die Darstellung von Fehlern und Validierungsnachrichten wird auch im xref:isyfact-standards-doku:isy-styleguide:styleguide.adoc[Styleguide] beschrieben.
...
Im xref:isyfact-standards-doku:isy-styleguide:styleguide.adoc[Styleguide] finden sich Beispiele für Druckansichten.
