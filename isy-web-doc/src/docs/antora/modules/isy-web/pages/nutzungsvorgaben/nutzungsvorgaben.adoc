...
Für eine GUI-Komponente wird zunächst die Definition des Flow als XML-Datei erstellt. 'WebFlowAutoConfiguration' sucht und findet den Flow selbständig und fügt ihn der Flow-Registry hinzu.
