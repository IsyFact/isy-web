...
[start=2]
2. *Maven Install*: In dem Modul `isy-web-lib` ist ein "Maven install" durchzuführen.
...
3. *Einbindung in Zielanwendung*: Die Datei `color.css` aus dem Target-Verzeichnis von `isy-web-lib` ist in die Zielanwendung unterhalb des WEB-INF Verzeichnisses zu kopieren.
