...
|====
|Name |Art |Version
|isy-web |Bibliothek |v6.0.0
|====
:linkaktuell: Nutzungsvorgaben isy-web-angular (Anmerkung: Dies ist noch ein Closed Source Baustein)
...
Allgemeine Angaben zur Gestaltung von Oberflächen finden sich im xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept].
...
Für die Erstellung von Web-GUIs existieren Vorgaben in Form eines xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzepts].
...
Die Darstellung von Fehlern und Validierungsnachrichten wird auch im xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept] beschrieben.
...
Die verwendeten Rechte müssen durch die Rollenrechte-Konfiguration (siehe xref:isyfact-standards-doku:isy-security:nutzungsvorgaben/master.adoc[Nutzungsvorgaben Security]) für den eingeloggten Benutzer entsprechend gesetzt werden.
...
Die Konfiguration der Security-Komponente ist in den xref:isyfact-standards-doku:isy-security:nutzungsvorgaben/master.adoc[Nutzungsvorgaben Security] beschrieben.
...
Im xref:isyfact-standards-doku:isy-bedienkonzept:bedienkonzept.adoc[Bedienkonzept] finden sich Beispiele für Druckansichten.
