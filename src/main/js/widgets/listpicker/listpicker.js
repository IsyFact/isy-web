...
export function registerListpickerHandlers() {
    ...
    /**
     * Function that expands the listpicker menu, if "downwards-arrow + alt"
     * (Event "keydown", Key-Code: 40) was pressed.
     */
...
/**
 * Used to reload Listpicker on ajax event, it's called via f:ajax call directly from xhtml-template
 */
...
/**
 * The function handles change and keyup events for listpickers that filter via servlet.
