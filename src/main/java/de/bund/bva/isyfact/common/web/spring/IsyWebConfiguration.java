...
@Configuration
//@ComponentScan({
//    "de.bund.bva.isyfact.common.web.layout",
//    "de.bund.bva.isyfact.common.web.jsf.components"
//})
@ComponentScan(basePackages = "de.bund.bva.isyfact.common.web")
public class IsyWebConfiguration {
...
//        return new GlobalFlowController(messageController, validationController, errorController,
//                aufrufKontextVerwalter, navigationMenuController);
//    }
...
//        return new NavigationMenuController(navigationMenuGenerierenStrategie);
//    }
