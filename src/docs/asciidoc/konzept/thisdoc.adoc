...
Zielgruppe dieses Dokuments sind Architekten, die sich einen Überblick über den Bausteins JSF verschaffen und wissen möchten, welche Architekturvorgaben und Architekturentscheidungen der Baustein mit sich bringt.
