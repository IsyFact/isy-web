...
Welche Controller im Detail (LinksnavigationController, QuicklinksController, ValidierungsController, ...) für das Vorgabelayout verfügbar sind, wird in <<NutzungsvorgabenJSF>> beschrieben.
