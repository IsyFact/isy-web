...
|*normal* und *hoch*
|Token per Session
|Bei jedem HTTP-Request wird ein Token mitgesendet um zu verifizieren, dass der Request wirklich vom angemeldeten Benutzer stammt.
Das Token wird in der Benutzer-Session gespeichert, damit können die Requests von überall im Browser abgesendet werden.
