...
Mit Hilfe der Session des Benutzers kann der Angreifer so Änderungen am System ausführen.
...
Weitere Details zur Konfiguration des CSRF-Schutzes stehen in <<NutzungsvorgabenJSF>>.
