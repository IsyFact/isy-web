...
----
// TODO: Stand 19.07.2018 Pfad isy-web z.Zt. noch richtig, bei einer Verzeichnisstrukturanpassung wäre das obige Beispiel anzupassen
...
<beans:bean id="WebFlowAuthenticationProvider"
	class="de.bund.bva.isycommon.isyweb.WebFlow.security.WebFlowAuthenticationProvider">
