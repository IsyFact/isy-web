...
Die folgenden Abschnitte erklären, wie eine GUI-Komponente nach dem MVC-Muster, mit der Erweiterung um Flows, mit der die Bibliothek `isy-web` erstellt wird.
...
=== Konfiguration von Spring Web Flow
...
Folgende Konfigurationsdatei muss in der anwendungsspezifischen GUI-Konfiguration angelegt und importiert werden:

:desc-listing-PfadWebflowXml: config.xml Konfigurationsdatei
